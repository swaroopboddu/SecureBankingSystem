...
<body>
<c:out value="${errorUpdateDepartment }"></c:out>
	<table class="display dataTable" id="list">
		...
		<tbody>
			...
			<c:forEach var="user" items="${listOfUsers}">
				<tr class="gradeX">
					<td align="justify"><c:out value="${user.userName}"></c:out></td>
					...
					<td align="justify"><c:out value="${user.department}"></c:out></td>
					<td align="justify"><a href="${pageContext.servletContext.contextPath}/official/removeManager/${user.userName}"> remove </a></td>
				</tr>
			</c:forEach>
