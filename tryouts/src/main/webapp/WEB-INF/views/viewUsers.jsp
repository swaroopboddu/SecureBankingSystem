		...
		<tbody>
			...
			<c:forEach var="user" items="${listOfUsers}">
				<tr class="gradeX">
					...
					<td align="justify"><a
						href="${pageContext.servletContext.contextPath}/sysadmin/resetPassword/${user.userName}">Reset Password
							</a></td>
					<td align="justify"><a
						href="${pageContext.servletContext.contextPath}/sysadmin/deleteUser/${user.userName}">Remove
							Employee</a></td>
				</tr>
			</c:forEach>
